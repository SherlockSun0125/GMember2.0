...
<body>
    <ul>
        <li><a href="${pageContext.request.contextPath}/pdfjs/build/a.pdf" target="pdfContainer" onclick="showPdf(true)">0001_pdf</a></li>
        <li><a href="${pageContext.request.contextPath}/pdfjs/build/b.pdf" target="pdfContainer" onclick="showPdf(true)">0002_pdf</a></li>
    </ul>
