                        ...
                        <div id="collapse1" class="accordion-body collapse">
                            <div class="accordion-inner">
                                <ul class="icons ul-list-2">
                                    <li><a href="${pageContext.request.contextPath}/about1.jsp">指导思想与基本思路</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about1.jsp">组织管理体系</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about1.jsp">试点的专业及学生规模</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about1.jsp">培养模式</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about1.jsp">培养计划和方案</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about1.jsp">工程经历师资队伍建设</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
