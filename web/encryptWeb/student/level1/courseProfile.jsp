                            ...
                            <div>
                                ...
                                <div class="j-post">
                                            ...
                                            <div class="f-cb">
                                                <table class="table table-bordered" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <div id="editor1" style="width: 100%;height: 100%;border: none;margin:0">
                                                                <p>${course.course_about}</p>
                                                            </div>
                                                            <textarea id="courseAbout" name="courseAbout" style="width:100%; height:200px;display: none">${course.course_about}</textarea>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                    ...
                                    editor1.customConfig.onchange=function (html) {
                                        courseAbout.val(html);
                                    };

                                    editor1.create();
                                    courseAbout.val(editor1.$txt.html);
                                    </script>
                                </div>
                            </div>
                        </div>
