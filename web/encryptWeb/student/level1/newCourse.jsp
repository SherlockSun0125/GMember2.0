                    ...
                    <div class="u-learn-modulewidth" style="width: 90%">
                        ...
                        <div class="j-detailBox">
                            <div>
                                ...
                                <div class="j-post">
                                    <form action="${pageContext.request.contextPath}/studentServlet?method=addCourse&stuid=${Student.stu_id}" method="post" onsubmit="return checkForm()">
                                            ...
                                            <div class="f-cb">
                                                <table class="table table-bordered" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="examTime" id="examTime">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="examGrade" id="examGrade" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="return false">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            ...
                                                            <textarea id="courseAbout" name="courseAbout" style="width:100%; height:200px;display: none"></textarea>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
