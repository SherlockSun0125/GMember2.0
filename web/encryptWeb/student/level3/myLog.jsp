                ...
                <div class="m-forumindex">
                    ...
                    <div class="f-cb">
                        <a class="j-newTopicBtn f-fl" style="margin-bottom:40px;margin-top: 12px;"
                           href="${pageContext.request.contextPath}/encryptWeb/student/level3/newLog.jsp"><img src="${pageContext.request.contextPath}/encryptWeb/student/static/addLog.png" style="width: 120px"></a>
                    </div>
