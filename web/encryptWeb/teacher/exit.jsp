...
<head>
    ...
    <style type="text/css">
        ...
        .m-logcnt .txt {
            background: url(/encryptWeb/teacher/static/logoutBg.jpg) no-repeat;
            height: 55px;
            line-height: 55px;
            padding-left: 80px;
            margin-left: 60px;
        ...
        .m-logcnt .txt2 {
            background: url(/encryptWeb/teacher/static/dialogicon.png) no-repeat;
            font-size: 18px;
        }
        ...
        .m-logcnt .sug .feedicon {
            background: url(/encryptWeb/teacher/static/ui_sprite.png) no-repeat -56px -1104px;
            margin-left: 3px;
            width: 12px;
            height: 12px;
        }
            ...
            <div class="f-pr f-cb">
                <div style="position: absolute;top:2px;bottom:2px;">
                    <a class="f-fl" hidefocus="true" href="${pageContext.request.contextPath}/home.jsp" target="_self" data-index="logo">
                        <img class="f-fl img" src="${pageContext.request.contextPath}/encryptWeb/teacher/static/hitwh_logo_white.png" title="学生主页" width="540px"
                    ...
                    <div class="userinfo f-fr f-cb f-pr">
                        <div class="login f-cb">
                                ...
                                <div class="f-pr">
                                    <div class="face">
                                        <img class="j-nav-myimg"
                                             src="${pageContext.request.contextPath}/encryptWeb/teacher/static/unLogin.jpg"
                            ...
                            <a data-index="消息" class="mes f-pr f-cb j-nav-mescenter"
                               href="${pageContext.request.contextPath}/teacherLogin.jsp" title="查看更多消息" target="_self">
                                <span>消息</span>
                            ...
                            <div class="u-mystudy f-pr f-cb f-fr">
                                <a class="mystudy nitem f-f0" id="j-nav-my-class" data-index="我的学习" target="_self"
                                   href="${pageContext.request.contextPath}/teacherLogin.jsp" hidefocus="true">讨论区</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="g-flow">
    ...
    <div class="g-logout f-bg">
        <div class="m-logcnt f-pr" >
            ...
            <a class="reLogin btn" id="j-reLogin" style="" href="${pageContext.request.contextPath}/teacherLogin.jsp">重新登录</a>
        </div>
        <div class="m-logbot">
