...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/teacherServlet?method=addTeacher"><i
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger" data-dismiss="modal" href="${pageContext.request.contextPath}/teacherServlet?method=deleteTeacher?teacherid=${tea.tea_id}">删除</a>
                    </div>
                </div>
            </div>
        </div>
