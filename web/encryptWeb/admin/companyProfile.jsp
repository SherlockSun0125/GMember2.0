            ...
            <div class="col-sm-12 col-md-12" style="margin-bottom: 10px ">
                <div class="panel panel-default" style="background-color: #EEEEEE">
                    ...
                    <div style="margin: 10px" class="comform">
                        <form action="${pageContext.request.contextPath}/companyServlet?method=updateCompany&comid=${company.com_id}" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
                            <div class="form-group" style="width:10%;">
                                ...
                                <div style="width:20em;display: inline-block">
                                    <select class="form-control" name="comtype" id="comtype">
                                        <c:forEach items="${comtypePageBean.beanList}" var="comtypes">
                                            <c:choose>
                                                <c:when test="${comtypes.comtype_id eq company.comtype_id}">
                                                    <option value="${comtypes.comtype_id}" selected="selected">${comtypes.comtype_name}</option>
                                                </c:when>
                                                <c:otherwise>
                            ...
                            <div class="form-group" style="width: 35%">
                                ...
                                <input type="text" class="form-control" name="comname" id="comname" value="${company.com_name}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <script id="container" name="content" type="text/plain">${company.com_info}</script>
                            </div>
                            <dic>
                                <small style="float: left;margin-left: 30px;margin-top: 20px">${msgUpdateCompany}</small>
