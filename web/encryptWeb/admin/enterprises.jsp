...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/encryptWeb/admin/addCompany.jsp"><i
                    class="fa fa-plus"></i>&nbsp;增加公司</a>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th style="text-align: center">公司类型</th>
            ...
            <c:forEach items="${pb.beanList}" var="company">
                <tr>
                    <td style="text-align: center">${company.com_id}</td>
                    <td style="text-align: center">
                        <a href="${pageContext.request.contextPath}/companyServlet?method=adminFindCompanyById&comid=${company.com_id}">${company.com_name}</a>
                    </td>
                    <td style="text-align: center">
                    ...
                    <td style="text-align: center">${company.com_time}</td>

                    <td style="text-align: center">
                        <a href="${pageContext.request.contextPath}/companyServlet?method=toUpdateCompany&comid=${company.com_id}"><i
                                class="fa fa-pencil"></i></a>
                        &nbsp;&nbsp;
                        <a href="${pageContext.request.contextPath}/companyServlet?method=deleteCompany&comid=${company.com_id}"
