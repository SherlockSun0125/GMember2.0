...
<div class="content">
    <div class="main-content">
        <div class="btn-toolbar list-toolbar">
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/companyServlet?method=toUpdateCompany&comid=${company.com_id}">
                <i class="fa fa-pencil"></i>&nbsp;修改公司信息</a>
        ...
        <div>
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td class="tname" style="border: 3px solid #EEEEEE">公司名称</td>
                        <td colspan="3" style="border: 3px solid #EEEEEE;">${company.com_name}</td>

                        <td rowspan="3" style="border: 3px solid #EEEEEE;text-align: left;width: 270px;height: 200px">
                            <img src="${pageContext.request.contextPath}/upload/company/img/${company.com_img}" style=" width: 270px;height: 200px">
                        </td>
                    </tr>
                    <tr>
                        <td class="tname"  style="border: 3px solid #EEEEEE">加入时间</td>
                        <td colspan="3" style="border: 3px solid #EEEEEE">${company.com_time}</td>
                    </tr>
                    <tr>
                        <td class="tname" style="border: 3px solid #EEEEEE">公司类型</td>
                        <td colspan="3" style="border: 3px solid #EEEEEE">
                            <c:forEach items="${comtypePageBean.beanList}" var="comtype">
                                <c:choose>
                                    <c:when test="${comtype.comtype_id eq company.comtype_id}">
                                        ${comtype.comtype_name}
                                    </c:when>
                                </c:choose>
                            </c:forEach>
                        </td>
                    ...
                    <tr>
                        <td class="tname" style="vertical-align: middle;text-align: center;border: 3px solid #EEEEEE">公<br/>司<br/>简<br/>介</td>
                        <td colspan="5"  style="border: 3px solid #EEEEEE">${company.com_info}</td>
                    </tr>
                </tbody>
            </table>
            <small>${msgUpdateCompany}</small>
