            ...
            <div class="span12">
                <nav id="menu" class="clearfix">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/companyServlet?method=findAllCompanys"><span>合作企业</span></a>
                        </li>
                        ...
                        <li class="current"><a href="${pageContext.request.contextPath}/about1.jsp"><span class="name">计划介绍</span></a></li>
                    </ul>
                </nav>
                ...
                <div class="accordion" id="accordion2">
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="collapse2" class="accordion-body collapse">
                            <div class="accordion-inner">
                                <ul class="icons ul-list-2">
                                    <li><a href="${pageContext.request.contextPath}/about2.jsp">背景</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about2.jsp">建设目标与指导思想</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about2.jsp">培养模式</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about2.jsp">培养方案与课程体系</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about2.jsp">实施方案要点</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about2.jsp">对各院系的要求</a></li>
                                    <li><a href="${pageContext.request.contextPath}/about2.jsp">机制政策</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
