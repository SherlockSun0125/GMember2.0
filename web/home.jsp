        ...
        <div class="row header-nav">
           <div class="span12">
                <nav id="menu" class="clearfix">
                    <ul>
                        <li class="current"><a href="${pageContext.request.contextPath}/home.jsp"><span class="name">主页</span></a>
                        </li>
        ...
        <div class="row">
            <div class="span12">
                <div id="mainslider" class="flexslider">
                    <ul class="slides">
                        <li>
                            <img src="${pageContext.request.contextPath}/images/myimg/hit_silde1.jpg" alt=""/>
                        ...
                        <li>
                            <img src="${pageContext.request.contextPath}/images/myimg/hit_silde2.jpg" alt="" />
                            <div class="slide-caption"  style="position: absolute;right: 0px">
                        ...
                        <li>
                            <img src="${pageContext.request.contextPath}/images/myimg/hit_silde3.jpg" alt="" />
                            <div class="slide-caption"  style="position:absolute;right: 0px;">
