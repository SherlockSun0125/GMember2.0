...
//    计算某生某阶段所有日志
    public int countLogsOfStudentLevel(@Param("stu_id") int stu_id,@Param("stu_level_id") int stu_level_id);
...
//    计算某老师某阶段所有学生日志
    public int countLogsOfTeacherLevel(@Param("tea_id")int tea_id,@Param("stu_level_id")int stu_level_id);

//    找到某阶段某位导师所有学生的所有日志，从from到from+pageSize
    public List<StuLog> findLogsOfEmployeeLevel(@Param("emp_id")int emp_id,@Param("stu_level_id")int stu_level_id,@Param("from")int from,@Param("pageSize")int pageSize);
//    计算某导师某阶段所有学生日志
    public int countLogsOfEmployeeLevel(@Param("emp_id")int emp_id,@Param("stu_level_id")int stu_level_id);
